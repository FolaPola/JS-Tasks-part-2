...
Почему нужен Origin, если Referer содержит даже больше информации? => так как Referer является необязательным 
HTTP-заголовком, по этому был изобретён Origin
Возможно ли отсутствие Referer или Origin, или это неправильно? => Referer - может отсутствовать, а Origin - нет */